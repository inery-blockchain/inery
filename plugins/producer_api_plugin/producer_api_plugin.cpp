#include <inery/producer_api_plugin/producer_api_plugin.hpp>
...
FC_REFLECT(inery::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     inery::detail::producer_api_plugin_response result{"ok"};
...
void producer_api_plugin::plugin_startup() {
   ...
   app().get_plugin<http_plugin>().add_api({
       ...
       CALL(producer, producer, get_account_mem_corrections,
            INVOKE_R_R(producer, get_account_mem_corrections, producer_plugin::get_account_mem_corrections_params), 201),
