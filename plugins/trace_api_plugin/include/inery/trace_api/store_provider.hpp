...
#include <inery/trace_api/metadata_log.hpp>
#include <inery/trace_api/data_log.hpp>
#include <inery/trace_api/compressed_file.hpp>

namespace inery::trace_api {
...
FC_REFLECT(inery::trace_api::slice_directory::index_header, (version))
