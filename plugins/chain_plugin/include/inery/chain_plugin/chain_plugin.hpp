...
#include <inery/chain/fixed_bytes.hpp>

#include <boost/container/flat_set.hpp>
#include <boost/multiprecision/cpp_int.hpp>

#include <inery/chain_plugin/account_query_db.hpp>
...
public:
   ...
   struct get_table_rows_params {
      ...
      optional<bool>  show_payer; // show MEM pyer
    };
   ...
   read_only::get_table_rows_result get_table_rows_by_seckey( const read_only::get_table_rows_params& p, const abi_def& abi, ConvFn conv )const {
      ...
      if( t_id != nullptr && index_t_id != nullptr ) {
         ...
         auto lower_bound_lookup_tuple = std::make_tuple( index_t_id->id._id,
                                                          inery::chain::secondary_key_traits<secondary_key_type>::true_lowest(),
                                                          std::numeric_limits<uint64_t>::lowest() );
         auto upper_bound_lookup_tuple = std::make_tuple( index_t_id->id._id,
                                                          inery::chain::secondary_key_traits<secondary_key_type>::true_highest(),
...
FC_REFLECT( inery::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT(inery::chain_apis::empty, )
FC_REFLECT(inery::chain_apis::read_only::get_info_results,
...
FC_REFLECT(inery::chain_apis::read_only::get_activated_protocol_features_params, (lower_bound)(upper_bound)(limit)(search_by_block_num)(reverse) )
FC_REFLECT(inery::chain_apis::read_only::get_activated_protocol_features_results, (activated_protocol_features)(more) )
FC_REFLECT(inery::chain_apis::read_only::get_block_params, (block_num_or_id))
FC_REFLECT(inery::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

FC_REFLECT( inery::chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )

FC_REFLECT( inery::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer) )
FC_REFLECT( inery::chain_apis::read_only::get_table_rows_result, (rows)(more)(next_key) );

FC_REFLECT( inery::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
FC_REFLECT( inery::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( inery::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

FC_REFLECT( inery::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( inery::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( inery::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

FC_REFLECT( inery::chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
FC_REFLECT( inery::chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

FC_REFLECT_EMPTY( inery::chain_apis::read_only::get_producer_schedule_params )
FC_REFLECT( inery::chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

FC_REFLECT( inery::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( inery::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );

FC_REFLECT( inery::chain_apis::read_only::get_account_results,
            (account_name)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
            (core_liquid_balance)(mem_quota)(net_weight)(cpu_weight)(net_limit)(cpu_limit)(mem_usage)(permissions)
            (total_resources)(self_delegated_bandwidth)(refund_request)(voter_info)/*(rex_info)*/ )
// @swap code_hash
FC_REFLECT( inery::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(wasm)(abi) )
FC_REFLECT( inery::chain_apis::read_only::get_code_hash_results, (account_name)(code_hash) )
FC_REFLECT( inery::chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( inery::chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol) )
FC_REFLECT( inery::chain_apis::read_only::get_code_params, (account_name)(code_as_wasm) )
FC_REFLECT( inery::chain_apis::read_only::get_code_hash_params, (account_name) )
FC_REFLECT( inery::chain_apis::read_only::get_abi_params, (account_name) )
FC_REFLECT( inery::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
FC_REFLECT( inery::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
FC_REFLECT( inery::chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
FC_REFLECT( inery::chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
FC_REFLECT( inery::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( inery::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( inery::chain_apis::read_only::abi_json_to_bin_result, (binargs) )
FC_REFLECT( inery::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( inery::chain_apis::read_only::abi_bin_to_json_result, (args) )
FC_REFLECT( inery::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( inery::chain_apis::read_only::get_required_keys_result, (required_keys) )
