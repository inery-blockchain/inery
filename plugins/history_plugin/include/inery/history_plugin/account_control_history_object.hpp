...
CHAINBASE_SET_INDEX_TYPE( inery::account_control_history_object, inery::account_control_history_multi_index )

FC_REFLECT( inery::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
