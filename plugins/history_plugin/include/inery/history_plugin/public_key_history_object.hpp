...
CHAINBASE_SET_INDEX_TYPE( inery::public_key_history_object, inery::public_key_history_multi_index )

FC_REFLECT( inery::public_key_history_object, (public_key)(name)(permission) )
