...
ACTION_TEMPLATE(ActionName,
                HAS_m_TEMPLATE_PAMEMS(kind1, name1, ..., kind_m, name_m),
                AND_n_VALUE_PAMEMS(p1, ..., p_n)) { statements; }
```
...
ACTION_TEMPLATE(DuplicateArg,
                ...
                HAS_2_TEMPLATE_PAMEMS(int, k, typename, T),
                AND_1_VALUE_PAMEMS(output)) {
...
| `ACTION_TEMPLATE(Foo, HAS_m_TEMPLATE_PAMEMS(...), AND_0_VALUE_PAMEMS())` |	`Foo<t1, ..., t_m>()` | `FooAction<t1, ..., t_m>` |
| `ACTION_P(Bar, param)` | `Bar(int_value)` | `BarActionP<int>` |
| `ACTION_TEMPLATE(Bar, HAS_m_TEMPLATE_PAMEMS(...), AND_1_VALUE_PAMEMS(p1))` | `Bar<t1, ..., t_m>(int_value)` | `FooActionP<t1, ..., t_m, int>` |
| `ACTION_P2(Baz, p1, p2)` | `Baz(bool_value, int_value)` | `BazActionP2<bool, int>` |
| `ACTION_TEMPLATE(Baz, HAS_m_TEMPLATE_PAMEMS(...), AND_2_VALUE_PAMEMS(p1, p2))`| `Baz<t1, ..., t_m>(bool_value, int_value)` | `FooActionP2<t1, ..., t_m, bool, int>` |
| ...                  | ...            | ...          |
