#include <inery/chain/webassembly/ine-vm-oc/gs_seg_helpers.h>
...
#define INEVMOC_MEMORY_PTR_cb_ptr GS_PTR struct ine_vm_oc_control_block* const cb_ptr = ((GS_PTR struct ine_vm_oc_control_block* const)(INE_VM_OC_CONTROL_BLOCK_OFFSET));

int32_t ine_vm_oc_grow_memory(int32_t grow, int32_t max) {
   INEVMOC_MEMORY_PTR_cb_ptr;
   ...
   current_gs += grow_amount * INE_VM_OC_MEMORY_STRIDE;
