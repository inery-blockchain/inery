 ...
 *         #YHR_INVALID_PAMEMETERS if verbosity is NULL
 *
 * @see YH_VERB_QUIET, YH_VERB_INTERMEDIATE, YH_VERB_CRYPTO, YH_VERB_RAW,
 * YH_VERB_INFO, YH_VERB_ERR, YH_VERB_ALL
 **/
 ...
 *         #YHR_INVALID_PAMEMETERS if either the URL or the connector are NULL.
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if the connector or the value are NULL or if
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if the connector does not exist.
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if the connector is NULL
 **/
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL.
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if the connector, the password or the session
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or incorrect.
 *         See #yh_rc for other possible errors
 *
 * @see <a
 *href="https://developers.yubico.com/YubiHSM2/Concepts/Session.html">Session</a>,
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or any of the
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if the session is NULL.
 *
 * @see <a
 *href="https://developers.yubico.com/YubiHSM2/Concepts/Session.html">Session</a>
 **/
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS input parameters are NULL or if
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS input parameters are NULL.
 *         See #yh_rc for other possible errors
 **/
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS input parameters are NULL or the algorithm is
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if session is NULL.
 *         See #yh_rc for other possible errors
 *
 **/
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL, <tt>in_len</tt>
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or if
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if <tt>session</tt> or <tt>val</tt> are NULL
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if <tt>result</tt> is NULL or if the
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if <tt>result</tt> is NULL.
 *
 * @see <a
 *href="https://developers.yubico.com/YubiHSM2/Concepts/Algorithms.html">Algorithms</a>
 **/
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or if the
 *algorithm is not supported by YubiHSM 2.
 *
 * @par Code sample
 *
 *     yh_algorithm algorithm;
 *     //yh_string_to_algo(NULL, &algorithm) => YHR_INVALID_PAMEMETERS
 *     //yh_string_to_algo("something", NULL) => YHR_INVALID_PAMEMETERS
 *     //yh_string_to_algo("something", &algorithm) => YHR_INVALID_PAMEMETERS
 ...
 *
 *     const char *string;
 *     //yh_type_to_string(0, NULL) => YHR_INVALID_PAMEMETERS
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or if the type
 *was not recognized.
 *
 * @par Code sample
 *
 *     yh_object_type type;
 *     //yh_string_to_type(NULL, &type) => YHR_INVALID_PAMEMETERS
 *     //yh_string_to_type("something", NULL) => YHR_INVALID_PAMEMETERS
 *     //yh_string_to_type("something", &type) => YHR_INVALID_PAMEMETERS
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL or if the option
 *was not recognized.
 *
 * @par Code sample
 *
 *     yh_option option;
 *     //yh_string_to_option(NULL, &option) => YHR_INVALID_PAMEMETERS
 *     //yh_string_to_option("something", NULL) => YHR_INVALID_PAMEMETERS
 *     //yh_string_to_option("something", &option) => YHR_INVALID_PAMEMETERS
 ...
 *
 * @return #YHR_SUCCESS if successful.
 *         #YHR_INVALID_PAMEMETERS if input parameters are NULL, if the domains
