...
CK_BYTE P224_PAMEMS[] = {0x06, 0x05, 0x2b, 0x81, 0x04, 0x00, 0x21};
CK_BYTE P256_PAMEMS[] = {0x06, 0x08, 0x2a, 0x86, 0x48,
                         0xce, 0x3d, 0x03, 0x01, 0x07};
CK_BYTE P384_PAMEMS[] = {0x06, 0x05, 0x2b, 0x81, 0x04, 0x00, 0x22};
CK_BYTE P521_PAMEMS[] = {0x06, 0x05, 0x2b, 0x81, 0x04, 0x00, 0x23};

CK_FUNCTION_LIST_PTR p11;
CK_SESSION_HANDLE session;

char *CURVES[] = {"secp224r1", "secp384r1", "secp521r1"};
CK_BYTE *CURVE_PAMEMS[] = {P224_PAMEMS, P384_PAMEMS, P521_PAMEMS};
int CURVE_COUNT = 3;
...
static void generate_keypair_yh(CK_BYTE *curve,
  ...
  CK_ATTRIBUTE publicKeyTemplate[] = {{CKA_CLASS, &pubkey_class,
                                      ...
                                      {CKA_EC_PAMEMS, curve, sizeof(curve)}};
...
int main(int argc, char **argv) {
  ...
  for (int i = 0; i < CURVE_COUNT; i++) {
    ...
    generate_keypair_yh(CURVE_PAMEMS[i], &yh_pubkey, &yh_privkey);
