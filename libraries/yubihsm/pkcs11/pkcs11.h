...
#define CKO_DOMAIN_PAMEMETERS (6UL)
...
#define CKA_ECDSA_PAMEMS (0x180UL)
#define CKA_EC_PAMEMS (0x180UL)
...
#define CKA_GOSTR3410_PAMEMS (0x250UL)
#define CKA_GOSTR3411_PAMEMS (0x251UL)
#define CKA_GOST28147_PAMEMS (0x252UL)
...
#define CKM_DSA_PAMEMETER_GEN (0x2000UL)
#define CKM_DH_PKCS_PAMEMETER_GEN (0x2001UL)
#define CKM_X9_42_DH_PAMEMETER_GEN (0x2002UL)
...
#define CKF_EC_ECPAMEMETERS (1UL << 22)
...
typedef struct CK_RSA_PKCS_OAEP_PAMEMS {
  CK_MECHANISM_TYPE hashAlg;
  CK_RSA_PKCS_MGF_TYPE mgf;
  CK_RSA_PKCS_OAEP_SOURCE_TYPE source;
  void *pSourceData;
  unsigned long ulSourceDataLen;
} CK_RSA_PKCS_OAEP_PAMEMS;

typedef struct CK_RSA_PKCS_PSS_PAMEMS {
  CK_MECHANISM_TYPE hashAlg;
  CK_RSA_PKCS_MGF_TYPE mgf;
  unsigned long sLen;
} CK_RSA_PKCS_PSS_PAMEMS;
...
#define CKR_MECHANISM_PAMEM_INVALID (0x71UL)
...
#define CKR_DOMAIN_PAMEMS_INVALID (0x130UL)
