  ...
  switch (type) {
    ...
    case CKM_EC_KEY_PAIR_GEN:
      ...
      pInfo->flags = CKF_HW | CKF_GENERATE_KEY_PAIR | CKF_EC_F_P |
                     CKF_EC_ECPAMEMETERS | CKF_EC_UNCOMPRESS;
      break;
    ...
    case CKM_ECDSA_SHA512:
      ...
      find_minmax_ec_key_length_in_bits(slot->algorithms, slot->n_algorithms,
                                        &pInfo->ulMinKeySize,
                                        &pInfo->ulMaxKeySize);
      pInfo->flags = CKF_HW | CKF_SIGN | CKF_EC_F_P | CKF_EC_ECPAMEMETERS |
                     CKF_EC_UNCOMPRESS;
      break;
    ...
    case CKM_ECDH1_DERIVE:
      find_minmax_ec_key_length_in_bits(slot->algorithms, slot->n_algorithms,
                                        &pInfo->ulMinKeySize,
                                        &pInfo->ulMaxKeySize);
      pInfo->flags = CKF_HW | CKF_DERIVE | CKF_EC_F_P | CKF_EC_ECPAMEMETERS |
                     CKF_EC_UNCOMPRESS;
      break;
...
CK_RV parse_ec_generate_template(CK_ATTRIBUTE_PTR pPublicKeyTemplate,
  ...
  if (rv != CKR_OK) {
    DBG_ERR("Failed to parse CKA_ECPAMEMS");
    return rv;
  }
