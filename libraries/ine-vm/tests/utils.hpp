...
#include <string>
#include <vector>
#include <inery/vm/stack_elem.hpp>
#include <inery/vm/utils.hpp>
...
inline bool check_nan(const std::optional<inery::vm::operand_stack_elem>& v) {
   return visit(inery::vm::overloaded{[](inery::vm::i32_const_t){ return false; },
                                      [](inery::vm::i64_const_t){ return false; },
                                      [](inery::vm::f32_const_t f) { return std::isnan(f.data.f); },
                                      [](inery::vm::f64_const_t f) { return std::isnan(f.data.f); }}, *v);
}

#define BACKEND_TEST_CASE(name, tags) \
  TEMPLATE_TEST_CASE(name, tags, inery::vm::jit, inery::vm::interpreter)
