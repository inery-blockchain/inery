...
mkdir -p ${PROJECT}/${VERSION}/opt/inery/lib/cmake
...
echo "class Inery < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/inery/ine/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/inery/ine/releases/download/v${VERSION}\"
